      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-20 md:py-28 w-full">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/send-story"
              className="inline-flex items-center gap-2 bg-gold hover:bg-gold-dark text-white font-bold font-cairo px-7 py-3.5 rounded-xl transition-all duration-300 hover:shadow-gold hover:-translate-y-0.5 text-sm"
            >
              <BookOpen size={17} />
              أرسل قصتك
            </Link>
            <Link
              href="/write"
              className="inline-flex items-center gap-2 bg-hope hover:bg-hope-dark text-white font-bold font-cairo px-7 py-3.5 rounded-xl transition-all duration-300 hover:-translate-y-0.5 text-sm"
            >
              <PenLine size={17} />
              اكتب معنا
            </Link>
            <Link
              href="/issues"
              className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold font-cairo px-7 py-3.5 rounded-xl transition-all duration-300 hover:-translate-y-0.5 text-sm"
            >
              <FolderOpen size={17} />
              تصفح القضايا
            </Link>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-16 md:mt-20">
          {[
            { value: "284+", label: "قصة منشورة", color: "#2F8F6B" },
            { value: "97+", label: "قضية موثقة", color: "#B84C4C" },
            { value: "156+", label: "مقال مشارك", color: "#C99A3E" },
            { value: "18", label: "منطقة مغطاة", color: "#0F766E" },
          ].map((stat) => (
            <div
              key={stat.label}
            ...
            >
              <div
                className="text-2xl md:text-3xl font-bold font-kufi mb-1"
